...
Description: <strong>*** NB: bespoked for LDSD so not safe to update automatically ***</strong> Admin panel for creating custom post types and custom taxonomies in WordPress.
